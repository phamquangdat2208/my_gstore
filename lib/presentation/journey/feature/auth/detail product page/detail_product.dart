...
import 'package:my_gstore/presentation/journey/feature/auth/detail%20product%20page/widget/product_detail_sliver_appbar.dart';
...
class _ProductDetailPageState extends State<ProductDetailPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: BlocBuilder<DetailProductCubit, DetailState>(
        bloc: _detailCubit,
        builder: (_, state) {
            ...
            return CustomScrollView(
              ...
              slivers: [
                SliverPersistentHeader(
                    delegate: ProductDetailSliverAppBar(
                  moveToCart: () {},
                  onFavourite: () {},
                  onIconMoreTap: () {},
                  onShare: () {},
                  product: state.getDetail,
                )),
                SliverToBoxAdapter(
                  child: Column(
                    children: [
                                        ...
                                        Container(
                                          ...
                                          child: Row(
                                            ...
                                            children: [
                                              ...
                                              Text(
                                                  '${state.getDetail.avgRating}',
                                                  style:
                                                      AppTextTheme.normalGrey),
                                              Text(
                                    ...
                                    Row(
                                      children: [
                                        ...
                                        Text(
                                            ...
                                            style: AppTextTheme.smallgreyline
                                                .copyWith(
                              ...
                              Stack(children: [
                                        ...
                                        children: [
                                          ...
                                          Container(
                                            ...
                                            child: BlocBuilder<
                                                ...
                                                builder: (_, state) {
                                                  if (state
                                                      is DetailGotDataState) {
                                                    if (state.getSampleShop
                                                        .isNotEmpty) {
                                          ...
                                          Container(
                                            ...
                                            child: BlocBuilder<
                                                ...
                                                builder: (_, state) {
                                                  if (state
                                                      is DetailGotDataState) {
                                                    if (state.getSampleProduct
                                                        .isNotEmpty) {
                                                      return Container(
                                                        color: AppColors.grey3,
                                                        child:
                                                            ListViewDetailProduct(
                                                          notExpand: true,
                                                          label: StringConst
                                                              .sameProduct,
                                                          productModel: state
                                ...
                                PageContainerDemo(
                                  ...
                                  child: DetailProductDirection(
                                    ...
                                    latLng: LatLng(
                                        21.064414507585408, 105.8317527955209),
                                    indexSelected: _index,
                                  ),
                                ),
                                PageContainerDemo(
